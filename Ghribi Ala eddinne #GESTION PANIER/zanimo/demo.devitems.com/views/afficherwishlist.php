        ...
        <div class="breadcrumb-area pt-95 pb-95 bg-img" style="background-image:url(assets/img/banner/banner-2.jpg);">
		 ...
		 <div class="cart-main-area pt-95 pb-100">
            <div class="container">
				...
				$listewishlists=$wishlist1C->afficherwishlists(1);
				?>
				<table>
				<thead>
				<tr>
				...
				foreach($listewishlists as $row){
					?>
					<tr>
					<td class="product-name"><?PHP echo $row['id_utilisateur']; ?></td>
					<td class="product-name"><?PHP echo "Dog Calcium Food"; ?></td>
                                ...
                                <div class="col-lg-12">
                                    <div class="cart-shiping-update-wrapper">
                                        <div class="cart-shiping-update">
                                            <a href="shop-list.html">Continue Shopping</a><br/>
