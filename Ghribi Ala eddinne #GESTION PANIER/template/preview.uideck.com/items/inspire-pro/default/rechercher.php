...
if (isset($_GET["s"]) AND $_GET["s"] == "Rechercher")
{
 ...
 if (isset($terme))
 {
  $select_terme = $bdd->prepare("SELECT id_commande, id_utilisateur,dateAchat,tabAchats,valide FROM commande WHERE id_commande LIKE ? ");
...
<?php
  while($terme_trouve = $select_terme->fetch())
  {
	...
	<td><?php echo $terme_trouve['tabAchats']; ?></td>
	<td>
	<?PHP 
